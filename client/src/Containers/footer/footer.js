    ...
    return (
        <>
            <footer className="fadeInUp col-md-12">
                <a href="/" className="button github"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                <a href="/" className="button btn-light medium">
            ...
            <h5 className="text-center copyright"> © Copyrights reserved by group</h5>
        </>
    )
}
